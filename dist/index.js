...
var LayoutContainer = function LayoutContainer(_ref) {
  ...
  return /*#__PURE__*/jsxs("div", {
    id: containerId,
    className: "flex ".concat(styles.string, " ").concat(widthStyle, " ").concat(heightStyle, " ").concat(className),
...
var getStylesForItem = function getStylesForItem() {
  ...
  try {
    if (itemName !== null) {
      ...
      var scrollbarStyles = "scrollable" in overrides && overrides["scrollable"] === true ? "overflow-y-scroll scrollbar scrollbar-thumb-gray-700 scrollbar-thin scrollbar-track-gray-800 flex-grow" : "overlflow-hidden ".concat(grow);
