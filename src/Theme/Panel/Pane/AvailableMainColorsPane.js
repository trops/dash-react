...
const AvailableMainColorsPane = ({ theme, themeVariant, mainColor, onChooseColor }) => {
    ...
    function renderAvailableColors() {
        ...
        return colorNames
            ...
            .map(colorName => {
                ...
                return (
                    <div className={`flex w-full h-full m-2 ${stringColor} ${selected === true ? 'opacity-100' : 'opacity-100'} rounded`} onClick={() => handleSelectMainColor(colorName)}>
