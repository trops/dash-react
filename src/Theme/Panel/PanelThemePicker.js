...
export const PanelThemePicker = ({ onUpdate, onCreateNew, onChangeVariant, theme = null, themeKey }) => {
            ...
            <div className='flex flex-col w-full h-full xl:space-x-4 overflow-hidden'>
                <div className='flex flex-row h-full rounded xl:space-x-4 w-full'> 
                    ...
                    <div className="flex flex-col w-full w-1/2 xl:w-3/4">
                        {theme !== null && (
                            <div className={`flex flex-row h-full rounded w-full overflow-hidden bg-gray-900 xl:space-x-2 p-2`}>
                                <ThemePickerGridPane 
                                    theme={theme} 
                                    themeKey={themeKey} 
                                    onClickNewTheme={handleCreateNewTheme}
