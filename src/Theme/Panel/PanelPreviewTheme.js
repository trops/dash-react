    ...
    function renderButtons() {
        ...
        return (
            <div className="flex flex-col space-y-4">
                <Button title="Button" {...buttonStyles} onClick={() => handleClickItem('button', buttonStyles)} />
                <Button2 title="Button 2" {...button2Styles} onClick={() => handleClickItem('button2', button2Styles)} />
                <Button3 title="Button 3" {...button3Styles} onClick={() => handleClickItem('button3', button3Styles)} />
            </div>
        );
    }
        ...
        return (
            <div className="flex flex-col space-y-2 w-full justify-center items-center">
                <div className="flex flex-row space-x-2">
                    <ButtonIcon text="Button Icon" icon="pencil" {...styles} onClick={() => handleClickItem('buttonIcon', styles)} />
                    <ButtonIcon icon="pencil" {...styles} onClick={() => handleClickItem('buttonIcon', styles)} />
                </div>
            </div>
        );
    }
    ...
    function renderMenuItem() {
        ...
        return (
            <div className="flex flex-col space-y-2">
                <MenuItem {...styles} onClick={() => handleClickItem('menuItem', styles)}>Menu Item</MenuItem>
                <MenuItem2 {...styles2} onClick={() => handleClickItem('menuItem2', styles2)}>Menu Item 2</MenuItem2>
                <MenuItem3 {...styles3} onClick={() => handleClickItem('menuItem3', styles3)}>Menu Item 3</MenuItem3>
            </div>
        );
    }
    ...
    function renderText() {
        ...
        return (
            <div className="flex flex-col space-y-4 p-4">
                <Heading title={'Heading'} {...headingStyles} padding={false} onClick={() => handleClickItem('heading', headingStyles)}/>
                <Heading2 title={'Heading 2'} {...heading2Styles} padding={false} onClick={() => handleClickItem('heading2', heading2Styles)}/>
                <Heading3 title={'Heading 3'} {...heading3Styles} padding={false} onClick={() => handleClickItem('heading3', heading3Styles)}/>
                <SubHeading title={'Subheading'} {...subHeadingStyles} padding={false} onClick={() => handleClickItem('subHeading', subHeadingStyles)}/>
                <SubHeading2 title={'Subheading 2'} {...subHeading2Styles} padding={false} onClick={() => handleClickItem('subHeading2', subHeading2Styles)}/>
                <SubHeading3 title={'Subheading 3'} {...subHeading3Styles} padding={false} onClick={() => handleClickItem('subHeading3', subHeading3Styles)}/>
                <Paragraph text={"The quick brown fox jumps over the lazy dog."} {...paragraphStyles} padding={false} onClick={() => handleClickItem('paragraph', paragraphStyles)}/>
                <Paragraph2 text={"The quick brown fox jumps over the lazy dog."} {...paragraph2Styles} padding={false} onClick={() => handleClickItem('paragraph2', paragraph2Styles)}/>
                <Paragraph3 text={"The quick brown fox jumps over the lazy dog."} {...paragraph3Styles} padding={false} onClick={() => handleClickItem('paragraph3', paragraph3Styles)}/>
            </div>
        );
    }
    ...
    return (
        ...
        <div className='flex flex-col w-full h-full xl:space-x-4 overflow-hidden'>
            <div className='flex flex-row h-full rounded space-x-0 xl:space-x-4 w-full'> 
                ...
                <div className="flex flex-row p-2 font-bold">{theme['name']} {themeVariant} </div>
                    {theme !== null && (
                        <div className={`flex flex-row h-full rounded w-full overflow-hidden bg-gray-900 space-x-0 xl:space-x-2 p-2`}>
                            {/* Theme Preview */}
                            <MainColorsPane theme={theme} variant={themeVariant} useSelected={false} />
                            <ThemePane>
                                <Panel className={'p-4 rounded h-full overflow-y-scroll'} {...getStylesForItem(themeObjects.PANEL, theme[themeVariant])}>
                                    <div className="flex flex-col space-y-2">
                                        {renderButtons()}
                                        {renderButtonIcon()}
                                        {renderMenuItem()}
                            ...
                            {itemColorSelected !== null && itemSelected !== null && (
                                <AvailableColorsPane onChooseColor={handleSelectColorForItem}/>
                            )}
