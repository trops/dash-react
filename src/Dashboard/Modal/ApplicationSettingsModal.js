...
export const ApplicationSettingsModal = ({ workspaces, open, setIsOpen, onSave }) => {
            ...
            <div className={`flex flex-col w-full h-full overflow-hidden`}>
                <div className='flex flex-row w-full h-full overflow-hidden'>
                    <div className="flex flex-row w-full h-full space-x-4 overflow-hidden p-4"> 
                        {/* Panel */}
                        <PanelApplicationSettings settings={settings} setIsOpen={setIsOpen} workspaces={workspaces} />
                    </div>
                </div>
