        ...
        try {
            ...
            if (component && m) {
                ...
                return children === null 
                    ? <WidgetComponent id={`widget-nokids-${key}`} key={`widget-nokids-${key}`} {...params} {...userPrefs} backgroundColor={bgColor} /> 
                    : (
                        <WidgetComponent id={`widget-kids-${key}`} key={`widget-kids-${key}`} {...params} {...userPrefs} backgroundColor={bgColor}>
