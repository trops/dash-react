    ...
    loadThemes: function (id, { callbackComplete = null, callbackError = null }) {
        try {
            ...
            if (a) {
                ...
                callbackComplete !== null && a.on(a.events.THEME_LIST_COMPLETE, callbackComplete);
                callbackError !== null && a.on(a.events.THEME_LIST_ERROR, callbackError);
                a.themes.listThemesForApplication(id);
            }
        } catch(e) {
            callbackError !== null && a.on(a.events.THEME_LIST_ERROR, (e, message) => callbackError(e, message));
        }
    },
};