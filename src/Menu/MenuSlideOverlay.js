    ...
    return (
        ...
        <Dialog as="div" className="fixed inset-0 overflow-hidden" onClose={setOpen}>
          <div className="absolute inset-0 overflow-hidden z-30">
            ...
            <div className="pointer-events-none fixed inset-y-0 left-0 flex max-w-full pl-12">
              <Transition.Child
                as={Fragment}
              ...
              >
                <div className="pointer-events-auto max-w-2xl xl:max-w-3xl overflow-hidden">
                  <div className={`flex h-full flex-col shadow-xl ${currentTheme['bg-secondary-very-dark']} ${currentTheme['text-secondary-light']} scrollbar scrollbar-thumb-gray-900 scrollbar-track-gray-900 overflow-hidden`}>
