...
function Toggle({ theme = true, text = "", enabled = false, setEnabled, backgroundColor = null, textColor = null, hoverBackgroundColor = null, ...props }) {
  
  const { currentTheme } = useContext(ThemeContext); 
  const styles = getStylesForItem(themeObjects.TOGGLE, currentTheme, { backgroundColor, textColor, hoverBackgroundColor });
