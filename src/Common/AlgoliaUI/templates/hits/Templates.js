        ...
        return (
            ...
            data.map((hit, index) => {
                ...
                const mustacheTemplate =
                    template !== null ? template : defaultTemplate;
                const parsedTemplate =
                    typeof mustacheTemplate !== "string"
                        ? JSON.stringify(mustacheTemplate)
                        : mustacheTemplate;
                ...
                const rankingInfo =
                    "_rankingInfo" in hit ? hit["_rankingInfo"] : null;
                const promoted =
                    rankingInfo !== null
                        ? "promoted" in rankingInfo
                            ? true
                            : false
                        : false;
                const promotedFromReRanking =
                    rankingInfo !== null
                        ? "promotedByReRanking" in rankingInfo
                            ? true
                            : false
                        : false;
                ...
                const analyticsForHit = analytics
                    ? hit.objectID in analytics
                        ? analytics[hit.objectID]
                        : null
                    : null;
                try {
                    return isDraggable === true && isPendingHide === false ? (
                        <AlgoliaDropComponent
                            key={`template-${hit.objectID}-${layoutId}`}
                            id={hit.objectID}
                            type={layoutId}
                            onDropItem={onDrop}
                            hitIndex={index}
                        ...
                        <div className="flex flex-col flex-1 w-full space-y-2 rounded overflow-hidden p-2">
                            ...
                            <div className="flex flex-col space-y-2 h-full justify-end">
                                ...
                                <div className="flex flex-row space-x-2">
                                    {/* <ButtonIcon icon="check" text="" bgColor='bg-gray-900' hoverBackgroundColor='hover:bg-gray-700' block />
                                <ButtonIcon icon="rocket" text="" bgColor='bg-gray-900' block hoverBackgroundColor='hover:bg-gray-700'/>
                                <ButtonIcon icon="info-circle" text="" bgColor='bg-gray-900' block hoverBackgroundColor='hover:bg-gray-700'/>
                                <ButtonIcon icon="xmark" text="" bgColor='bg-gray-900' hoverBackgroundColor='hover:bg-gray-700' block/> */}
                                </div>
                            </div>
                        </div>
                    );
...
const CarouselTemplateComponent = ({
    hits,
    fields = [],
    limit,
    template,
                            ...
                            >
                                <div className="flex flex-col justify-start items-start z-10  h-full rounded opacity-75 space-x-2">
                                    {analyticsForHit !== null && (
                                        <Fragment>
                                            <Tag
                                                text={`CTR ${analyticsForHit["clickThroughRate"]}`}
                                                color="bg-green-600"
                                            />
                                            <Tag
                                                text={`CR ${analyticsForHit["conversionRate"]}`}
                                                color="bg-green-600"
                                            />
                                        </Fragment>
                                    )}
...
export { CarouselTemplateComponent, HitsTemplateComponent };
