...
export const MainSection = ({ children, backgroundColor = null }) => {
    ...
    const backgroundColorStyle = backgroundColor !== null ? backgroundColor : (currentTheme !== null ? currentTheme['bg-primary-very-dark'] : 'bg-black');
    console.log('MAIN SECTION COLOR STYLE', backgroundColorStyle);
    return currentTheme !== null && (
        <div className={`flex flex-col ${backgroundColorStyle} h-full overflow-hidden w-full`}>{children}</div>
    )
    //  : (
