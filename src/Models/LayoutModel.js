...
export const LayoutModel = (layoutItem, workspaceLayout, dashboardId) => {
    ...
    try {
        ...
        layout.scrollable = 'scrollable' in obj 
            ? ((obj['scrollable'] === "false" || obj['scrollable'] === false) ? false : true)
            : false;
        ...
        if (layout.parentWorkspaceName === undefined || Object.keys(layout.parentWorkspace).length === 0) {
            ...
            const parentWS = getNearestParentWorkspace(workspaceLayout, tempLayout, tempLayout);
